...
\newpage
\section{Principio d'Inerzia - prima legge di Newton}
...
Ogni sistema di riferimento che si muove a velocità costante rispetto ad un sistema di riferimento inerziale, è esso stesso un sistema inerziale.

È possibile riformulare la prmia legge di Newton in un modo più pratico:
\begin{displayquote}
    \centering
